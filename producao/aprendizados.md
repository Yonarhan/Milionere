...
- 2026-09-25: série bíblica escrita parte por parte (plano → 4 roteiros do zero → juiz da série reescrevendo) rodava 27+ min e não fechava. Agora (`episodios.py`): história COMPLETA num roteiro só → juiz 1 vez → corte em episódios (só gancho, recap, suspense e CTA são novos) → camada 1 por episódio → juiz da série 1 passada.
- 2026-09-25: alias `sonnet` do CLI virou Sonnet 5 e escrevia 150-250 palavras num limite de ~110. Roteirista e juiz fixos em `claude-sonnet-4-6`.
