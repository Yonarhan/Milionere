...
def _escolher(r: dict, cenas: list[int], cache: dict, pasta: Path, rodada: int) -> dict[int, dict]:
    ...
    prompt = (
        ...
        "Cena de chamada no fim (comenta, manda pra alguém, se inscreve): uma imagem bonita do assunto do vídeo; nada "
        "de celular, tela, aplicativo ou perfil de rede social (aparece o canal de outra pessoa).\n\n"
