...
# 避免依赖中的同名 app 包遮蔽 Milionere 自己的 app 包。
...
st.set_page_config(
    page_title="Milionere",
    page_icon="🤖",
    layout="wide",
    initial_sidebar_state="auto",
    menu_items={
        "Report a bug": "https://github.com/Yonarhan/Milionere/issues",
        "About": "# Milionere\nSimply provide a topic or keyword for a video, and it will "
        "automatically generate the video copy, video materials, video subtitles, "
        "and video background music before synthesizing a high-definition short "
        "video.\n\nhttps://github.com/Yonarhan/Milionere",
    },
)


# Streamlit 1.59 会在页面右上角默认展示 Deploy、skills nudge 等平台入口。
# Milionere 是面向终端用户的本地工具，这些入口会造成顶部大块空白，
...
def _render_brand(available_update: str | None = None):
    ...
    st.markdown(
        f"""
        <h1 class="mpt-brand">
            <span class="mpt-brand__name">Milionere</span>
            <a class="mpt-brand__version"
               href="https://github.com/Yonarhan/Milionere"
               target="_blank"
               rel="noopener noreferrer"
               aria-label="Open Milionere on GitHub"
