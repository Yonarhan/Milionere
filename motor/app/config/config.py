...
def load_config():
    # fix: IsADirectoryError: [Errno 21] Is a directory: '/Milionere/config.toml'
...
project_name = _cfg.get("project_name", "Milionere")
project_description = _cfg.get(
    "project_description",
    "<a href='https://github.com/Yonarhan/Milionere'>https://github.com/Yonarhan/Milionere</a>",
)
