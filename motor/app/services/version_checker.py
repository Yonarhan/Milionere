...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/Yonarhan/Milionere/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/Yonarhan/Milionere/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "Milionere-Version-Checker",
}
...
def get_available_update(current_version: str) -> str | None:
    ...
    视频生成等核心功能。
    """
    return None  # Milionere: sem checagem de atualização externa
    try:
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a Milionere update"
            )
